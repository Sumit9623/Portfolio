    ...
    <Container>
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInput type='email' placeholder="Your Email" name="email" />
          <ContactInput type='text' placeholder="Your Name" name="name" />
          <ContactInput type='text' placeholder="Subject" name="subject" />
          <ContactInputMessage type='text' placeholder="message" rows="4" name="message"/>
